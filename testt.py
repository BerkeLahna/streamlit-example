...
def main():
    ...
    with col2:
        ...
        st.button("+1", on_click=plus, args=(1, 'cons.conf.idx'),key = "cons.conf.idx_add_1")
        st.button("-1", on_click=minus, args=(1, 'cons.conf.idx'),key = "cons.conf.idx_rem_1")
        st.button("+.01", on_click=plus, args=(0.01, 'euribor3m'),key = "euribor3m_add_1")
        st.button("-.01", on_click=minus, args=(0.01, 'euribor3m'),key = "euribor3m_rem_1")
    ...
    with col3:
        ...
        st.button("+5", on_click=plus, args=(5, 'cons.conf.idx'),key = "cons.conf.idx_add_5")
        st.button("-5", on_click=minus, args=(5, 'cons.conf.idx'),key = "cons.conf.idx_rem_5")
        st.button("+.05", on_click=plus, args=(0.05, 'euribor3m'),key = "euribor3m_add_5")
        st.button("-.05", on_click=minus, args=(0.05, 'euribor3m'),key = "euribor3m_rem_5")

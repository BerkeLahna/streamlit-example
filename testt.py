...
def main():
    ...
    with col2:
        ...
        st.button("+0.01", on_click=plus, args=(0.1, 'cons.conf.idx'),key = "cons.conf.idx_add_1")
        st.button("-0.01", on_click=minus, args=(0.1, 'cons.conf.idx'),key = "cons.conf.idx_rem_1")
    ...
    with col3:
        ...
        st.button("-1", on_click=minus, args=(1, 'cons.price.idx'),key = "cons.price.idx_rem_5")

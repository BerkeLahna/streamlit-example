...
def main():
    ...
    input_data = {
        ...
        'duration': st.number_input("Enter call duration in seconds:", min_value=0, max_value=3600, value=300),
        'campaign': st.number_input("Enter number of contacts performed during this campaign for this client:", min_value=0, max_value=50, value=5),
        'pdays': st.number_input("Enter number of days that passed after the client was last contacted from a previous campaign:", min_value=0, max_value=1000, value=0),
        'previous': st.number_input("Enter number of contacts performed before this campaign for this client:", min_value=0, max_value=50, value=0),
